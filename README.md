...
🧩 **[OpenClaw Audit Button][oc-audit-skill]** (Feb 2026) - An OpenClaw skill that adds a Security Audit (--deep) dashboard button with clear status states and chat-posted audit results.
